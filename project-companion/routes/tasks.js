...
router.get('/', (req, res) => {
  ...
  res.render('tasks/index', { tasks, phases, currentPhase: phase || 'All', currentStatus: status || 'All', msg: req.query.msg || null });
});
...
router.post('/:id/delete', (req, res) => {
  db.prepare('DELETE FROM RiskTask WHERE task_id = ?').run(req.params.id);
